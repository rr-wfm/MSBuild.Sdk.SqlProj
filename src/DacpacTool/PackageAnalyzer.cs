    ...
    public sealed class PackageAnalyzer
    {
        ...
        public void Analyze(TSqlModel model, FileInfo outputFile, FileInfo[] analyzers)
        {
            ...
            try
            {
                ...
                {
                    _console.WriteLine("DacpacTool warning SQLPROJ0001: No additional well-known rules files found, consider adding more rules via PackageReference - see the readme here: https://github.com/rr-wfm/MSBuild.Sdk.SqlProj/blob/master/README.md#static-code-analysis. You can ignore this warning with '<NoWarn>$(NoWarn);SQLPROJ0001</NoWarn>' in your project file.");
                }

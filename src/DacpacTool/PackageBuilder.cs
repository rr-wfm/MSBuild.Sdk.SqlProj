    ...
    public sealed class PackageBuilder : IDisposable
    {
        ...
        public void SetProperty(string key, string value)
        {
            try
            {
                ...
                {
                    "AcceleratedDatabaseRecovery" => bool.Parse(value),
                    ...
                    "DataRetentionEnabled" => bool.Parse(value),
                    "DateCorrelationOptimizationOn" => bool.Parse(value),
                    "DBChainingOn" => bool.Parse(value),
                    "DbScopedConfigDWCompatibilityLevel" => int.Parse(value, CultureInfo.InvariantCulture),

...
#pragma warning restore CA1031 // Do not catch general exception types
    ...
    private void RunDeploymentScriptFromReferences(FileInfo dacpacPackage, string targetDatabaseName, bool isPreDeploy)
    {
        ...
        foreach (var reference in references)
        {
            ...
            engine.BatchParserExecutionError += (_, args) => _console.WriteLine(args.Format(_currentSource));
            engine.ScriptExecutionFinished += (_, args) => _console.WriteLine($"Executed {scriptPrefix}-deployment script for referenced package " +

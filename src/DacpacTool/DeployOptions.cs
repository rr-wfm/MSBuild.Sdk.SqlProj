...
#pragma warning restore CA1812 // Avoid uninstantiated internal classes
    {
        ...
        [CliOption(Description = "Name of the server to deploy the package to", Required = false, Name = "--targetServerName", Alias = "-tsn")]
        ...
        [CliOption(Description = "Name of the database to deploy the package to", Required = false, Name = "--targetDatabaseName", Alias = "-tdn")]
        ...
        [CliOption(Description = "Encrypt the connection; defaults to the profile setting, or false without a profile", Required = false, Name = "--encrypt", Alias = "-e")]
        public bool? Encrypt { get; set; }

        [CliOption(Description = "Publish profile; explicit command line options override its settings", Required = false, Name = "--profile")]
        public FileInfo Profile { get; set; }

        // SDK fallback values are separate from explicit overrides so profile
        // settings win over project defaults without losing legacy defaults.
        [CliOption(Name = "--defaultTargetServerName", Required = false)]
        public string DefaultTargetServerName { get; set; }

        [CliOption(Name = "--defaultTargetDatabaseName", Required = false)]
        public string DefaultTargetDatabaseName { get; set; }

        [CliOption(Name = "--defaultProperty", Required = false)]
        public string[] DefaultProperty { get; set; }

        [CliOption(Name = "--defaultSqlCmdVar", Required = false)]
        public string[] DefaultSqlCmdVar { get; set; }

...
#pragma warning restore CA1812 // Avoid uninstantiated internal classes
    {
        ...
        [CliOption(Description = "Username used to connect to the target server, using SQL Server authentication", Required = false)]
        public string? TargetUser { get; set; }
        
        [CliOption(Description = "Password used to connect to the target server, using SQL Server authentication", Required = false)]
        public string? TargetPassword { get; set; }
        
        [CliOption(Description = "Properties used to control the deployment", Required = false)]
        ...
        [CliOption(Description = "Encrypt the connection, defaults to false", Required = false)]

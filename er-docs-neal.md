...
```json
{
  "$schema": "https://raw.githubusercontent.com/rr-wfm/MSBuild.Sdk.SqlProj/master/src/MSBuild.Sdk.SqlProj/Sdk/EntityRelationshipDiagramConfig.schema.json",Expand commentComment on line R644Resolved
  "tables": [
    "dbo.Customer",
    "OrderHeader"
  ]
